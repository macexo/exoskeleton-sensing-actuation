...
/**
  * @brief  Brings the LSM6DSO32 up on I2C1: confirms the sensor is responsive,
  *         restores a known register state, keeps the bus on I2C, then sets
...
static void imu_init(void)
{
  ...
  lsm6dso32_i2c_interface_set(&imu, LSM6DSO32_I2C_ENABLE);
